...
DebPackages=(
             ...
             ["slack-desktop"]="https://downloads.slack-edge.com/releases/linux/4.36.140/prod/x64/slack-desktop-4.36.140-amd64.deb"
            )
...
NodeJsVer="node-v20.11.1-linux-x64"
NodeJsPkg="$NodeJsVer.tar.xz"
NodeJsUrl="https://nodejs.org/dist/v20.11.1/$NodeJsPkg"
...
GoLangPkg="go1.22.0.linux-amd64.tar.gz"
